        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingAddressSnapshot = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    BillingAddressId = table.Column<int>(type: "int", nullable: true),
                    BillingAddressSnapshot = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpiresAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Requires3DSecure = table.Column<bool>(type: "bit", nullable: false),
                    ThreeDSecureUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
